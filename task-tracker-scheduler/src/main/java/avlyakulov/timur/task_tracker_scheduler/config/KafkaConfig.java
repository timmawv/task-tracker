package avlyakulov.timur.task_tracker_scheduler.config;
...
public class KafkaConfig {
    ...
    @Bean
    ProducerFactory<String, DailyReportDto> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }

    @Bean
    KafkaTemplate<String, DailyReportDto> kafkaTemplate() {
